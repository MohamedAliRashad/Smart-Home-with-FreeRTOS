...
void ADC0_start_conversion(void)
{
    ...
    //   while((ADC0_RIS_R & (1 << 3)) == 0) ; /* Uncomment this if you want to check the ADC Flag */

    while (ADC0_SSFSTAT3_R & ADC_SSFSTAT3_EMPTY) /* Comment this if you don't want to check the FIFO Flag */
        ;
